#!/usr/bin/env python3
"""
Run LightGBM + Direct Strategy Backtest
...
print("=" * 80)
print("LIGHTGBM + DIRECT BACKTEST (3-MONTH VALIDATION)")
print("=" * 80)
print()
...
output_file = output_dir / f'lightgbm_direct_3month_{timestamp}.csv'
...
lgb_recursive_w1 = 19.79
lgb_direct_w1 = wapes[0]
difference = lgb_recursive_w1 - lgb_direct_w1

print("Comparison to LightGBM Recursive (3-month):")
print("-" * 80)
print(f"Recursive W1 WAPE:  {lgb_recursive_w1:.2f}%")
print(f"Direct W1 WAPE:     {lgb_direct_w1:.2f}%")
...
print()
print("=" * 80)
print("LIGHTGBM DIRECT COMPLETE - AWAITING USER APPROVAL FOR XGBOOST DIRECT")
print("=" * 80)

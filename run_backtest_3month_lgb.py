...
print("=" * 80)
print("LIGHTGBM + RECURSIVE BACKTEST (3-MONTH VALIDATION)")
print("=" * 80)
print()
...
# Compare to 6-month baseline
baseline_w1_wape = 19.03
lgb_3m_w1_wape = wapes[0]
difference = baseline_w1_wape - lgb_3m_w1_wape

print("Comparison to 6-month baseline:")
print("-" * 80)
print(f"6-month W1 WAPE:   {baseline_w1_wape:.2f}%")
print(f"3-month W1 WAPE:   {lgb_3m_w1_wape:.2f}%")
